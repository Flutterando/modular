...
class ModularArguments {
  ...
  const ModularArguments({this.params = const {}, this.data, required this.uri});

  ModularArguments copyWith({Map<String, dynamic>? params, dynamic data, Uri? uri}) {
    return ModularArguments(params: params ?? this.params, data: data ?? this.data, uri: uri ?? this.uri);
  }
