...
class Bind<T extends Object> extends BindContract<T> {
  ...
  static Bind<T> singleton<T extends Object>(T Function(Injector i) inject, {bool export = false, void Function(T)? onDispose}) {
    return Bind<T>(inject, isSingleton: true, isLazy: false, isScoped: false, export: export, onDispose: onDispose);
  }

  ///Create single instance for request.
  static Bind<T> scoped<T extends Object>(T Function(Injector i) inject, {bool export = false, void Function(T)? onDispose}) {
    return Bind<T>(inject, isSingleton: true, isLazy: true, isScoped: true, export: export, onDispose: onDispose);
  }
