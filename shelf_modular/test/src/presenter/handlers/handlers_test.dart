...
import 'package:shelf_modular/src/presenter/handlers/handlers.dart';
...
void main() {
  ...
  test('Handler1', () {
    expect(
      _applyHandler((ModularArguments args) => Response.ok('')),
      isNotNull,
    );
  });
  ...
  test('Handler2', () {
    expect(
      _applyHandler((AutoInjector injector) => Response.ok('')),
      isNotNull,
    );
  });
  ...
  test('HandlerTwoParams1', () {
    expect(
      _applyHandler((Request request, AutoInjector i) => Response.ok('')),
      isNotNull,
    );
  });
  ...
  test('HandlerTwoParams5', () {
    expect(
      _applyHandler((AutoInjector i, Request request) => Response.ok('')),
      isNotNull,
    );
  });
