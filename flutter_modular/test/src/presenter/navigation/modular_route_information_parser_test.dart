...
void main() {
  ...
  test('selectBook one', () async {
    ...
    when(() => getRoute.call(any())).thenAnswer((_) async => Success(routeMock));
  ...
  test('selectBook with parents', () async {
    ...
    when(() => getRoute.call(const RouteParmsDTO(url: '/test'))).thenAnswer((_) async => Success(routeMock));
    when(() => getRoute.call(const RouteParmsDTO(url: '/'))).thenAnswer((_) async => Success(routeParent));
    when(() => getArguments.call()).thenReturn(Success(ModularArguments.empty()));
  ...
  test('selectRoute with RedirectRoute', () async {
    ...
    when(() => getRoute.call(const RouteParmsDTO(url: '/oo'))).thenAnswer((_) async => Success(redirect));
    when(() => getRoute.call(RouteParmsDTO(url: '/test', arguments: modularArgument.data))).thenAnswer((_) async => Success(routeMock));
    when(() => getRoute.call(const RouteParmsDTO(url: '/'))).thenAnswer((_) async => Success(routeParent));
  ...
  test('selectRoute with resolver route withless /', () async {
    ...
    when(() => getRoute.call(RouteParmsDTO(url: '/test', arguments: args))).thenAnswer((_) async => Failure(ModularPageException('')));
    when(() => getRoute.call(RouteParmsDTO(url: '/test/', arguments: args))).thenAnswer((_) async => Success(routeMock));
  ...
  test('parseRouteInformation with location null', () {
    ...
    expect(parser.parseRouteInformation(const RouteInformation(location: '/test')), completion(isA<ModularBook>()));
    expect(parser.parseRouteInformation(const RouteInformation(location: '/test')), completion(isA<ModularBook>()));
  ...
  test('parseRouteInformation with location / and guard false', () {
    ...
    expect(() => parser.parseRouteInformation(const RouteInformation(location: '/')), throwsA(isA<GuardedRouteException>()));
  });
  ...
  test('parseRouteInformation with location / and middleware null', () {
    ...
    expect(() => parser.parseRouteInformation(const RouteInformation(location: '/')), throwsA(isA<Exception>()));
  });
