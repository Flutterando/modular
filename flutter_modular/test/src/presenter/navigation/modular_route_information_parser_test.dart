...
void main() {
  ...
  test('parseRouteInformation with location / and guard false', () {
    ...
    expect(() async => await parser.parseRouteInformation(const RouteInformation(location: '/')), throwsA(isA<GuardedRouteException>()));
  });
  ...
  test('parseRouteInformation with location / and middleware null', () {
    ...
    expect(() async => await parser.parseRouteInformation(const RouteInformation(location: '/')), throwsA(isA<Exception>()));
  });
